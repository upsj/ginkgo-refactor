...
void kernel2(std::shared_ptr<const gko::ReferenceExecutor> exec, gko::matrix::Dense<double>*, gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*);
...
Operation make_kernel2(gko::matrix::Dense<double>*, gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*, const gko::matrix::Dense<double>*);
...
void foo() {
    ...
    ref->run(make_kernel2(mtx.get(), mtx2, mtx.get(), mtx2, mtx3.get(), mtx4));
    kernels::kernel(ref, mtx.get(), mtx2, mtx3.get(), mtx4);
    kernels::kernel2(ref, mtx.get(), mtx2, mtx.get(), mtx2, mtx3.get(), mtx4);
...
void foo() {
    ...
    ref->run(make_kernel2(mtx->get_device_view(), mtx2->get_device_view(), mtx->get_const_device_view(), mtx2->get_const_device_view(), mtx3->get_const_device_view(), mtx4->get_const_device_view()));
    kernels::kernel(ref, mtx->get_device_view(), mtx2->get_device_view(), mtx3->get_const_device_view(), mtx4->get_const_device_view());
    kernels::kernel2(ref, mtx->get_device_view(), mtx2->get_device_view(), mtx->get_const_device_view(), mtx2->get_const_device_view(), mtx3->get_const_device_view(), mtx4->get_const_device_view());
    kernels::non_kernel(mtx.get(), mtx2, mtx3.get(), mtx4);
}
